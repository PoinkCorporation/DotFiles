...
func TestCreateInviteLink_Fail_NoUserID(t *testing.T) {
	ctx, st := suite.New(t)

	_, err := st.ChatClient.CreateInviteLink(ctx, &chatv1.CreateInviteLinkRequest{})
	require.Error(t, err)
...
func TestJoinChatByInvite_Fail_NoID(t *testing.T) {
	ctx, st := suite.New(t)

	_, err := st.ChatClient.JoinChatByInvite(ctx, &chatv1.JoinChatByInviteRequest{JoinedId: randomID()})
	require.Error(t, err)
...
func TestJoinChatByInvite_Fail_NoJoinedID(t *testing.T) {
	ctx, st := suite.New(t)

	_, err := st.ChatClient.JoinChatByInvite(ctx, &chatv1.JoinChatByInviteRequest{Id: randomID()})
	require.Error(t, err)
